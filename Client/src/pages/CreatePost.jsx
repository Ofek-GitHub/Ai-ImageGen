        ...
        <section className={"max-w-7xl mx-auto"}>
            <div>
                ...
                <p className={"mt-2 text-[#666e75] text-[24px] max-w-[500px]"}>
                    Create imaginative and visually stunning images through DALL-E AI and share it with the community.
                </p>
            </div>
            <form className={"mt-16 max-w-3xl"} onSubmit={handleSubmit}>
                <div className={"flex flex-col gap-5"}>
                    ...
                    <div className={"relative bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg " +
                        ...
                        {generatingImg && (
                            <div className={"absolute insert-0 z-0 flex justify-center items-center bg-[rgba(0,0,0.5)] rounded-lg"}>
                                <Loader />
                            </div>)}
